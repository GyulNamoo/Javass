 ...
 *      => Full statck : Ajax, VueJS, React(React-Query), Redux 
 *                                                        ----- MVC 구조
 ...
 *                           ------------------------------------------
 *                           |                                        |
 *                         CheckdException                    UnCheckedException
 *                         ---------------                   --------------------
 ...
 *                                 ----- 데이터 저장 : 크롤링 
 *                          => MalFormedURLException : IP, URL주소가 틀린경우
 *                             ---------------------
 ...
 *                 => throws 문장
 *                 
 *                    public void disp() throws ArrayInedexOfBoundsException, NumberFormatException,
 *                                              NullPointerException
 *                    {
 *                    }
 *                    
 *                    => 호출시에 등록된 예외처리를 한 후에 사용한다 
 *                    
 *                    public void print()
 *                    {
 *                        disp(); => 정상 수행 (에외처리가 없어도 된다) => UnCheckedException
 *                    }
 *                    
 ...
 *                    }
 *                    
 *                    => 라이브러리 => 이미 소스 코딩이 되어 있는 상태 => try ~ catch보다 throws가 편리하다
 *                                                                           ------ 유지보수 
 *    
 */
