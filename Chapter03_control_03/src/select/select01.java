 ...
 *              else => 로그인이 안 된 상태
 *              {
 *                 조건이 false일 때 처리 ==> 아이디 / 비밀번호가 틀리다 메세지 전송
 *              }
 ...
 *             }
 *        => 선택문 : 다중조건문을 단순화 => 웹에서는 거의 사용 빈도가 없다
 *                                     화면 이동(JSP) => Spring
 *                                     => Front (Router)
 *                                     => 간결하다 => 게임 ( 키보드값 )
		  ...
		  case '/':
			...
			// 연산자가 잘못된 경우
			  default:
				  ...
				  //마지막 break 사용할 수 있고 사용하지 않을 수 있다
