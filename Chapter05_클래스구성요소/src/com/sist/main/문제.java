...
-----------------------------------------------------
=> 하나의 클래스로 하나의 객체만 생성할 수 있다. => new를 이용하면 여러개의 객체 생성 가능
--------------------------------------------------
4) 객체는 클래스의 인스턴스이다.
	클래스 제작
	{
...
--------------------------------------------------
4) 클래스는 반드시 필드와 메소드를 가져야 한다. => 메소드만 or 필드만 가능 
          ----
--------------------------------------------------
   1. 클래스의 종류
...
8. 인스턴스 멤버와 정적 멤버에 대한 설명으로 틀린 것은 무엇입니까?  2번
