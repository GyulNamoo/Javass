...
public class Library_07 {
	...
	public void fileOutput()
	{
		...
		try {
			...
			fw = new FileWriter(file,true);  // true : 기존의 데이터를 유지하고 다음줄에 출력...!! => append
			...
			sawon.setSabun(maxSabun()+1); // static => 메모리에 젖아시에는 프로그램 종료시에 자동으로 사라진다 => 값 = 1 초기화 
			// => 파일에서 사번을 읽어서 증가... 
