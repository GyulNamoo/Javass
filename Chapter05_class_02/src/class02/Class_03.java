...
public class Class_03 {
	...
	public static void main(String[] args) {
		...
		// 1. 학생 생성
		// hong 메모리 주소 => name, subject, school_name,year,hakbun => .을 이용해서 접근
		...
		//2.학생 생성
		//shim 메모리 주소 => name, subject, school_name,year,hakbun => .을 이용해서 접근
