 ...
 *             변수 묶음
 *               1. 변수의 종류
 *                  = 객체변수 => new이용해서 저장시마다 메모리가 달라진다(저장공간이 따로 생긴다)
...
class Card
{
	...
	/*
	 *     -----------------------------------------------------------------------
	 *       종류       메모리에 저장 시점       메모리에 해제        저장위치       사용범위
	 *     ------------------------------------------------------------------------
	 *      지역변수      메소드 호출           메소드가 종료         statck      메소드 안에서만 사용 가능
	 *                  => 메모리에 저장       return에서 해제
	 *     -----------------------------------------------------------------------
	 *      인스턴스변수   new를 이용할 경우      프로그램 종료시       Heap          클래스 전체 사용이 가능
	 *                                                          			  => 다른 클래스에서도 사용가능
	 *      class A
	 *      {
	 *        int aa;
...
public class class_01{
	...
	public static void main(String[] args) {
		...
		System.out.println("card1.width=" + card2.width); //500
		System.out.println("card1.height=" + card2.height); //1000
