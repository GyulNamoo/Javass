 ...
 *                  ----------------------
 *                    구현이 안된 메소드 : 핵심
 *                    (publlic abstract) 리턴형 메소드명(매개변수...);
 *                    ------------------
 *                     없는 경우에 자동 추가 (생략이 가능) 
 *                  ----------------------
 *                    구현된 메소드 => default 메소드
 ...
 *                     interface B
 *                     class C
 *                     class D (클래스상속) (인터페이스 상속)
 *                     class D extends C implements A,B => 윈도우에서 등장
 *                             --------- -------------- 
 *                     *** 특별한 경우가 아닌 경우 => 웹은 주로 사용하는 것 => 클래스로 묶어서 관리
 *                                             -------
 *                                             서로 다른 클래스 연결해서 사용
 *           내부 클래스 => 네트워크, 게임
 *                      ------
 ...
 *                          -------------  -----------
 *                               |               |
 *                               ---------------- IP,PORT => 클래스와 클래스간의 공통으로 사용되는 변수, 메소드가 있는 경우 
 */
