...
public class BoardDetail extends JPanel{
	...
	nameLa = new JLabel("번호", JLabel.CENTER);
	nameLa.setBounds(70,110,80,30);
	...
	sub = new JLabel("제목", JLabel.CENTER);
	hit.setBounds(10,140,80,30);
	hit = new JLabel("");
	hitLa.setBounds(90,145,400,30);
	add(hitLa); add(hit);
