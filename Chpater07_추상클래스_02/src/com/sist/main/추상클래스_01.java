 ...
 *                       ------
 *                         | 에러방지 => 에러(소스상에서 수정할 수 없는 에러) / 예외처리(소스상에서 수정이 가능한 에러)
 ...
 *       }
 *       
 *       => 주로 사용되는 곳은 클래스마다 기능은 동일한데 => 구현내용이 틀린경우 => 선언 => 유지보수가 편리하게 만든다
 *       => 사이트마다 약간씩 다르다 ...
 *          ----------------
 *           로그인, 로그아웃 ..., 회원가입 ...
 *           => 네이버 => Ajax
 ...
 *            interface A
 *            {
 *            	(public static final) int a; => 오류발생 => 변수 / 상수 (수정 : int a = 10;)
