 ...
 */
import java.util.*; //파일 입출력 => 데이터 읽기 => 메모리에 저장
import java.io.*;
...
public class memberVar_ini {
	...
	// 파일 읽기 => 구현 
	{
		try 
		{
			...
			int j=0;
			for(String mm : movie) {
				movies[j] = new Movie(); //클래스초기화 => 저장할 공간을 만든다
	...
	public static void main(String[] args) {
		...
		memberVar_ini m = new memberVar_ini();
		/*
		 *     m 
		 *        => movies[1938]
		 *        => m.movies
	...
	/*	System.out.println("===== 영화 목록 =====");
		...
		System.out.println("감독:" + mm.actor);
