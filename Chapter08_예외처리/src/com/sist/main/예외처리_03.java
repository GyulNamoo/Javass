 ...
 *                             발생된 위치에서 비정상 종료한다
 *                                        --------
 *                                        비정상 종료를 방지하고 정상 종료가 가능하게 만드는 방법
 *      => 문제가 발생
 ...
 *                                        |소스코딩
 *                               -----------------------------------------------------------------------
 *                                이미 소스코드가 완료된 상태 => try~catch를 만들기 어렵기 때문에 ...
...
public class 예외처리_03 {
	...
	public static void main(String[] args) {
		...
		//첫번째 에러
		int n1 = Integer.parseInt(num1); // 문자열을 정수로 변환 ==> 유효성검사 
		// => 에러 발생 의심부분 1
		...
		// num1, num2, n1, b2, b3 => try블록안에서만 사용이 가능 => 블록변수 / 지역변수
		// ==> {}안에서만 사용이 가능
		} 
		...
		//RuntimeException, ArithmeticException ........RuntimeException
