 ...
 *   RuntimeException
 *       |
 *       NumberFormatException , NullPointerException, ClassCastExcetion
 *       
 *       Exception > RuntimeException >  NumberFormatException , NullPointerException, ClassCastExcetion
 *                   ----------------
 *                   |3가지 동시에 처리가 가능 
 */
import java.util.*;
...
public class 예외처리_04 {
	...
	public static void main(String[] args) {
		...
		// 전체를 잡아주는 예외처리 ==> RuntimeExceptionRuntimeException
