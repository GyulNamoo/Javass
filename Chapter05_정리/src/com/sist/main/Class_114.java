 ...
 *                       => 공통으로 사용되는 변수값을 지정
 *                       => 데이터 전체 를 모아서 관리 => 오라클 (공유된 데이터) => 마이페이지
 *                       => 동작 
 ...
 *                     = 파일읽기 
 *                 ----------------------------------------------------
 *                 *** static메소드안에서는 static변수, static메소드만 사용이 가능
 *                      => 인스턴스를 사용하고 싶은 경우
 *                         new를 이용해서 메모리 할당후 사용
 *                 *** 인스턴스 메소드안에서는 모든 것을 사용이 가능
 *                   class A
 *                   {
 *                       int a = 10; => 인스턴스
 *                       static int b = 20; => 정적
...
public class Class_114 {
	...
	public static void main(String[] args) {
		...
		*/ /*
		...
		// 클래스 안에서 생성자 호출시에 this()를 이용한다
		// this() 반드시 생성자 안에서만 호출 => 첫번째 줄에서 호출 => 한번만 사용이 가능 => 한두번정도 나온다
