...
public class MovieManager {
	//Movie에 있는 모든 데이터를 읽어서 저장 => 변수 => 모든 User가 공통된 데이터
	...
	public MovieManager()
	{
		...
		try {
			...
			FileReader fr = new FileReader("c:\\javaDex\\movie.txt");
			...
			String data=sb.toString(); // 전체데이터를 모은다
	...
	public Movie[] movieFindData(String title) {
		...
		// 선언 => 갯수 확인 => 갯수확인 => 데이터값 채우기 => 동일하면 선언 => 동일하지 않는 경우
