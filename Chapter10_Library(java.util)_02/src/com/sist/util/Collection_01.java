...
/*
 *      Collelction : 배열을 대처 => 가변형 (저장갯수를 지정하지 않는다)
 *                                     ------------------- 신축성
 *      1. 컬렉션 프레임워크
 ...
 *                             -------- 배열은 불가능하다 (고정)
 *         = 동적 메모리 할당 (가변형)
 *           필요시마다 데이터를 추가, 삭제하기 편리하다
 *           => 웹, 모바일 => 컬렉션을 이용해서 데이터를 전송 
...
public class Collection_01 {
	...
	public static void main(String[] args) {
		...
		ArrayList list = new ArrayList(); // 가변형 => 데이터 저장갯수를 지정하지 않는다 
		/*
		 *   접근 속도가 늦다, 추가,삭제가 빠르다
		 *   -----------  
		 */
		// 1. 저장 => add () => 마지막에 추가
		list.add("홍길동");  //0
