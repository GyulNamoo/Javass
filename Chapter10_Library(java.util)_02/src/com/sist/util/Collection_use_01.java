...
public class Collection_use_01 extends JFrame implements ActionListener{
	JButton up,in,del,exit;
	JTable table;
	DefaultTableModel model;
	SawonSystem ss = new SawonSystem();
	
	public Collection_use_01(){
		up = new JButton("수정");
		in = new JButton("추가");
		del = new JButton("삭제");
		exit = new JButton("종료");
	...
	{	for(int i = model.getRowCount()-1; i>=0; i--)
		...
		for(Sawon s:list)
		{
			String[] temp = {String.valueOf(s.getSabun()), s.getName(), s.getDept(),
							s.getJob(), String.valueOf(s.getPay())};
		}
	}
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		new Collection_use_01();
	}
