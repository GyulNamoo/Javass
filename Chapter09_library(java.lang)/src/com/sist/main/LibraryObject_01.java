...
/*
 *     class JFrame
 *     class LibraryObject_01 extends JFrame
 *           ---------------- Obejct, JFrame
 *           
 *     클래스의 크기
 *     ---------
...
public class LibraryObject_01 extends JFrame implements ItemListener{
	JComboBox box;
	JLabel la;
	////// ==> 포함 클래스 => has-a
	public LibraryObject_01()
	{
	...
	public static void main(String[] args) {
		...
		// 생성자 호출
		new LibraryObject_01();

	}
	@Override
	public void itemStateChanged(ItemEvent e) {
		// TODO Auto-generated method stub
		if(e.getSource() == box) // box 에서 선택이 되었다면
		{
