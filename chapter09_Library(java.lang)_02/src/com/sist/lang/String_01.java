 ...
 *          => public int length()
 *          => "Hello Java"
 *              0123456789  => 10 => 영문 / 한글 => 글자 수 (공백을 포함한다)
 *                                                      --- space 문자
 *          => ..., 비밀번호확인 / MMS
 ...
 *       ------------------------------------------
 *        검색
 *        4. startsWith() : 시작문자열이 같은 경우
 *           public boolean startsWidth(String start)
 *            => 서제스트를 만드는 경우에 주로 사용
 *               ------ 자동완성기 
 *            => cookie 저장 => cookie 읽기 
 *               => 문자열만 저장이 가능
 ...
 *           public boolean endsWidth(String end)
 *           => 확장자 찾기
 ...
 *        *** 9. lastIndesOf() : 뒤에서부터 찾기 (경로명, 확장자)
...
public class String_01 {
	...
	public static void main(java.lang.String[] args) {
		...
		if(s1 == s2) // ==는 객체일 때 => 메모리 주소값을 비교한다 => 실제 문자열만 비교할 때는 equals
		{
		...
		if(s1 == s3)
		{
			System.out.println("s1 과 s3는 같다");
		} 
		else {
