 ...
 *              
 *              인스턴스 변수 => 여러개를 동시에 저장 => new를 이용해서 생성 (new 이용하면 메모리 공간이 따로 생성) => heap
 *                            영화 정보 / 음악 정보 ...
 ...
 *                 
 *                 display(10.4, 'A', 10) double char int
 * 				   해당 매개변수가 없는 경우 => 가장 가까준 매개변수를 찾아 준다     
 * 
 *             	   class A
 *                 {
 *                    public void display(){}
 ...
 *             }
 *             = 정적 메소드
 *             public 리턴형 메소드명(매개변수목록) 클래스명.메소드명
 *             {
 *             }
 *             
 *             = 추상 메소드
...
public class Class_01 {
	...
	public static void main(String[] args) {
		...
		Class_01 a = new Class_01();
		//       -   ------------  동일
		a.display(100);
		new Class_01().display(100);
		new Class_01().display('A');
